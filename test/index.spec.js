...
describe('É dia útil?', function () {
    ...
    var tests = [
        ...
        { givenDate: '2017-10-21', description: 'Dia de Nossa Senhora Aparecida', expectedResult: false },
        { givenDate: '2016-10-21', description: 'Dia de Nossa Senhora Aparecida', expectedResult: false },
        { givenDate: '1980-10-21', description: 'Dia de Nossa Senhora Aparecida', expectedResult: false },
        { givenDate: '1988-10-21', description: 'Dia de Nossa Senhora Aparecida', expectedResult: false },
        { givenDate: '2050-10-21', description: 'Dia de Nossa Senhora Aparecida', expectedResult: false },
        { givenDate: '2023-10-21', description: 'Dia de Nossa Senhora Aparecida', expectedResult: false },
